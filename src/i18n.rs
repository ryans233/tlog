...
pub struct Messages {
    ...
    pub help_display_opts: &'static str,

    // ── Options screen ──────────────────────────────────────────────────
    pub opts_title: &'static str,
...
pub const EN: Messages = Messages {
    ...
    help_options: "Show display config",
    help_bypass: "Toggle filter bypass",
    help_tab: "Switch focus to filter",
    help_esc: "Cancel filter / return",
    help_display_opts: "Toggle display (1 ts/2 PID/3 TID/4 Tag/5 level/6 color)",

    opts_title: "── Display Config ────────────────────────",
...
pub const ZH: Messages = Messages {
    ...
    help_tab: "切换焦点到过滤器",
    help_esc: "取消过滤/返回",
    help_display_opts: "切换显示选项 (1时间戳/2PID/3TID/4Tag/5等级/6颜色)",
